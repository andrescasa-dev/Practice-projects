...
function App() {
  ...
  const getDeleteUserHandler = (id:number)=> ()=>{
        ...
        <TableBody>
            {users.map((user)=>(
              <TableRow key={user.id}>
                ...
                <TableCell>
                <svg xmlns="http://www.w3.org/2000/svg" onClick={getDeleteUserHandler(user.id)}  className="w-6 h-6 cursor-pointer" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
